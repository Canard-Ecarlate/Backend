...
public class RoomControllerUt
{
    ...
    [Theory]
    [InlineData(ConstantTest.String, ConstantTest.ObjectId, ConstantTest.String, ConstantTest.True, ConstantTest.Five)]
    public void CreateRoomTest(string roomName, string hostId, string hostName, bool isPrivate, int nbPlayers)
    {
        ...
        // Mock
        _mockRoomService.Setup(mock => mock.AddRooms(roomName, hostId, hostName, isPrivate, nbPlayers)).Returns(room);
